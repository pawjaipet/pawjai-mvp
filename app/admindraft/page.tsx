...
function buildAdminDraftReturnTo(searchParams?: { bookingView?: string; newDogId?: string; newDogState?: string; role?: string; shelter?: string; view?: string; visitBucket?: string }) {
...
export default async function AdminDraftPage({
  ...
  searchParams?: Promise<{ bookingView?: string; message?: string; newDogId?: string; newDogState?: string; role?: string; shelter?: string; unlock?: string; view?: string; visitBucket?: string }>;
}) {
