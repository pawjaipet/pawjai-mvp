...
function Panel({
  ...
  return (
    <section className="rounded-[32px] border border-[#d6c8ad] bg-white p-6 shadow-[0_16px_50px_rgba(101,88,79,0.08)]">
      <div className="mb-4 flex items-center gap-3 text-[#65584f]">
        {icon}
  ...
  return (
    ...
    >
      {isImage && signedUrl ? (
        ...
        <div className="flex h-24 items-center justify-center bg-[#f8f0e5] text-[#65584f]">
          <FileText size={28} />
        </div>
      )}
      <div className="p-4">
...
export default async function AdminVisitorProfilePage({
  ...
  await requireShelterAccess(typedAppointment.shelter_id, `/admindraft/bookings/${id}/visitor-profile`);
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-4xl font-semibold text-[#65584f]">{fullName(typedAdopter)}</h1>
            <p className="mt-2 text-sm text-[#65584f]">
              {typedAdopter?.email ?? "No email"} · {typedAdopter?.phone_number ?? "No phone"}
            </p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Link className="rounded-full border border-[#d6c8ad] bg-white px-5 py-2 text-sm font-semibold text-[#65584f] hover:bg-[#f5f1e8]" href={`/admindraft/bookings/${typedAppointment.id}`}>
        ...
        <section className="mb-5 rounded-[32px] border border-[#d6c8ad] bg-white p-6 shadow-[0_16px_50px_rgba(101,88,79,0.08)]">
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
          <Panel icon={<UserRound size={20} />} title="Adopter profile and lifestyle">
            ...
            <div className="mt-5 rounded-2xl bg-[#f8f0e5] p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#65584f]">Shelter questionnaire Q&A</p>
              {answers.length === 0 ? (
                ...
                <div className="mt-3 grid gap-3">
                  {answers.map(({ answer, question }) => (
                    <div className="rounded-2xl bg-[#fffaf5] p-4" key={answer.id}>
                      <p className="text-xs font-semibold uppercase tracking-[0.12em] text-[#65584f]">
          ...
          <Panel icon={<ShieldCheck size={20} />} title="Match preferences">
            ...
            <div className="mt-5 rounded-2xl bg-[#f8f0e5] p-4">
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-[#65584f]">Full filter preferences</p>
