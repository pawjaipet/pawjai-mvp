...
import { initialPawjaiAdminGateState } from "./form-state";
...
export default async function PawjaiProfileAdminPage({
  searchParams,
}: {
    ...
    <div className="mx-auto max-w-6xl px-4 py-8">
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          <TabLink href="/admin" active={false}>Create dog</TabLink>
          <TabLink href="/admin/listings" active={false}>Manage listings</TabLink>
