      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {adminContext.isGlobalAdmin ? navLink("/admin/ads", "Ads") : null}
            {adminContext.isGlobalAdmin ? navLink("/admin/pawjaiprofile", "About content") : null}
            {adminContext.isGlobalAdmin ? navLink("/admin/accounts", "Accounts") : null}
            {navLink("/admin/audit", "Audit", true)}
          </div>
        </div>
