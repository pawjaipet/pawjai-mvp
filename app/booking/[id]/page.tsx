...
export default async function AdminBookingDetailPage({
  ...
  const currentBookingHref = withReturnTo(`/booking/${typedAppointment.id}`, bookingListHref);
  const visitorProfileHref = withReturnTo(`/booking/${typedAppointment.id}/visitor-profile`, bookingListHref);
        ...
        <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            <p className="text-sm font-medium uppercase tracking-[0.24em] text-[#b77624]">
              {context.isGlobalAdmin ? "PawJai Booking Workspace" : "Shelter Booking Workspace"}
            </p>
